export const Empty = () => {
  return (
    <div className="flex flex-col items-center justify-center max-w-xl mx-auto gap-y-5 flex-1">
      <svg
      ...
      <div className="space-y-1 text-center">
        <h3 className="text-2xl font-medium">Tu carrito está vacío</h3>
        <p className="text-gray-700 text-balance">
          Aún no agregaste productos. Explora nuestro catálogo y encuentra el terno ideal para tu próxima ocasión.
        </p>
      </div>

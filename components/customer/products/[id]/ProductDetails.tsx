    ...
    <div className="flex flex-col gap-y-10">
      ...
      <div className="flex flex-col gap-y-5">
        ...
        <div className="flex items-center gap-x-4">
            ...
            <div className="flex items-center gap-x-2">
                <button className="px-3 py-1 border border-gray-300 hover:border-primary transition">S</button>
                <button className="px-3 py-1 border border-gray-300 hover:border-primary transition">M</button>
                <button className="px-3 py-1 border border-gray-300 hover:border-primary transition">L</button>
                <button className="px-3 py-1 border border-gray-300 hover:border-primary transition">XL</button>
            </div>
        </div>
        ...
        <div className="flex items-center gap-x-2">
          ...
          <svg
            ...
            className="lucide lucide-star-icon lucide-star text-yellow-500 fill-yellow-500"
          >
            <path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z" />
          </svg>
          <p className="text-gray-700 leading-none text-lg mt-1">4.5</p>
          <p className="font-medium leading-none text-lg mt-1">(120 reseñas)</p>
        </div>

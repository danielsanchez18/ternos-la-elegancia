              ...
              {data.recentAdmins.map((admin) => (
                ...
                >
                  ...
                  <p className="mt-3 text-xs text-stone-500">
                    Alta {dateFormatter.format(admin.createdAt)} · email{" "}
              ...
              <div className="space-y-3">
                {data.adminUsers.map((admin) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-xs text-stone-500">
                      Creado {dateFormatter.format(admin.createdAt)} · email{" "}
                      {admin.emailVerified ? "verificado" : "no verificado"}
                    </p>
                  </article>
                ))}
                ...
                {data.recentSessions.map((session) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-sm leading-6 text-stone-300">
                      {session.userAgent ?? "Sin user-agent"} · expira{" "}
